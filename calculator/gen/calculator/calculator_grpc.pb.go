...
type CalculatorClient interface {
	...
	PrimeNumberDecomposition(ctx context.Context, in *NRequest, opts ...grpc.CallOption) (Calculator_PrimeNumberDecompositionClient, error)
...
func (c *calculatorClient) Sum(ctx context.Context, in *SumRequest, opts ...grpc.CallOption) (*ResultResponse, error) {
...
func (c *calculatorClient) PrimeNumberDecomposition(ctx context.Context, in *NRequest, opts ...grpc.CallOption) (Calculator_PrimeNumberDecompositionClient, error) {
...
func (x *calculatorPrimeNumberDecompositionClient) Recv() (*DecomposedNumber, error) {
	m := new(DecomposedNumber)
...
type Calculator_ComputeAverageClient interface {
	...
	CloseAndRecv() (*NumberStream, error)
	grpc.ClientStream
}
...
func (x *calculatorComputeAverageClient) Send(m *NumberStream) error {
	return x.ClientStream.SendMsg(m)
}

func (x *calculatorComputeAverageClient) CloseAndRecv() (*NumberStream, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(NumberStream)
...
func (x *calculatorFindMaximumClient) Send(m *FindMaxRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *calculatorFindMaximumClient) Recv() (*FindMaxResponse, error) {
...
type CalculatorServer interface {
	...
	PrimeNumberDecomposition(*NRequest, Calculator_PrimeNumberDecompositionServer) error
...
func (UnimplementedCalculatorServer) Sum(context.Context, *SumRequest) (*ResultResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Sum not implemented")
}
func (UnimplementedCalculatorServer) PrimeNumberDecomposition(*NRequest, Calculator_PrimeNumberDecompositionServer) error {
...
func (x *calculatorPrimeNumberDecompositionServer) Send(m *DecomposedNumber) error {
...
type Calculator_ComputeAverageServer interface {
	SendAndClose(*NumberStream) error
...
func (x *calculatorComputeAverageServer) SendAndClose(m *NumberStream) error {
	return x.ServerStream.SendMsg(m)
}

func (x *calculatorComputeAverageServer) Recv() (*NumberStream, error) {
	m := new(NumberStream)
...
func (x *calculatorFindMaximumServer) Send(m *FindMaxResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *calculatorFindMaximumServer) Recv() (*FindMaxRequest, error) {
...
var Calculator_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "calculator/protos/calculator/calculator",
}
